...
const UpdateParkingSpacee = () => {
    ...
    const { _id, name, quantity, supplier, taste, category, details, photo } = parking;
    ...
    const handleUpdateparking = event => {
        ...
        const updatedparking = { name, quantity, supplier, taste, category, details, photo }
    ...
    return (
        <div className="bg-[#F4F3F0] p-24">
            ...
            <form onSubmit={handleUpdateparking}>
                ...
                <div className="md:flex mb-8">
                    <div className="form-control md:w-1/2">
                        ...
                        <label className="input-group">
                            <input type="text" name="name" defaultValue={name} placeholder="parking Name" className="input input-bordered w-full" />
                        </label>
                    </div>
                ...
                <input type="submit" value="Update parking" className="btn btn-block" />
