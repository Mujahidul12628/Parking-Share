...
const ParkingSpaceCardItem = ({ parking, setParkings, parkings }) => {
            ...
            <div className="p-4 card-body">
                ...
                <div className="flex justify-between card-actions">
                    ...
                    <Link to={`updateparking/${_id}`}>
                        <button className=" flex items-center px-3 py-1 mt-3 text-white font-semibold bg-blue-400 rounded-md">Edit  </button>
                    </Link>
                    <Link to="/details:">
                        <button className=" flex items-center px-3 py-1 mt-3 text-white font-semibold bg-blue-400 rounded-md">Reservation <BsArrowRightCircle className="font-semibold ml-2 w-6 h-6 text-white" /> </button>
                    </Link>
                    <button
                        onClick={() => handleDelete(_id)}
                        className=" flex items-center px-3 py-1 mt-3 text-white font-semibold bg-blue-400 rounded-md">Delete <MdDeleteForever className="font-semibold ml-2 w-6 h-6 text-white" /> </button>
                </div>
            </div>
        </div>
